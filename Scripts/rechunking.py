...
def optimized_hybrid_chunking(docs_df, semantic_min_size=150, semantic_max_size=400,
    ...
    # Get last doc_id from hybrid_chunks.csv and increment by 1
    try:
        hybrid_chunks_df = pd.read_csv('hybrid_chunks.csv')
        id_counter = hybrid_chunks_df['doc_id'].max() + 1
    except:
        id_counter = 1
...
if __name__ == "__main__":
    ...
    result_df.to_csv('new_hybrid_chunks.csv', index=False)
